# from kivy.textpad import rectangle
...
class WidgetsExample(GridLayout):
    ...
    def on_slider_value(self, widget):
        print("Widget" + str(int(widget.value)))
        #
...
class CanvasExample4(Widget):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        with self.canvas:
            Line(points=(0, 0, 400, 500), width=2)
            Color(0, 1, 0)
            Line(circle=(400, 200, 80), width=2)
            Line(rectangle=(500, 100, 150, 400), width=5)
            self.rect = Rectangle(pos=(600, 50), size=(100, 50))
